...
// ─── Fallback images if a service has no uploaded image ──────────────────────
...
// Derive a short uppercase tag from the service name (first word, max 8 chars)
...
export function PremiumServices() {
  ...
  useEffect(() => {
    servicesApi
      .list()
      .then(({ data }) => {
        // Prefer featured services first; cap at 4 cards

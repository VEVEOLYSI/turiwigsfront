...
import { DollarSign, Plus, CheckCircle, RefreshCw, Trash2 } from 'lucide-react';
    ...
    <div className="space-y-5 pb-8">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex gap-2">
          <button onClick={() => load()} disabled={loading} className="flex items-center gap-1.5 rounded-xl px-3 py-1.5 text-xs font-medium border border-neutral-200 text-neutral-600 hover:bg-neutral-50">
